...
# creating an empty list to store a list of shoes objects
shoes = []

# open the file inventory.txt and read the data from this file the create shoes object and append this object into the shoes list
def read_shoes_data():
    ...
    try:
        ...
        with open(filename, 'r') as f:
            ...
            for line in f:
                ...
                lineNo += 1
        print("Data read from inventory.txt files")
    except IOError:
...
#user is also given choice of updating the quantity
def re_stock():
...
#creating main menu in awhile loop to execute the functions above
